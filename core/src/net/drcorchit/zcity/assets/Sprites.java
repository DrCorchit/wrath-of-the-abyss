...
public class Sprites {
	...
	public static final AnimatedSprite torso0 = initSprite(Textures.torso, 22, 16);
	public static final AnimatedSprite head0 = initSprite(Textures.head, 18, 18);
	public static final AnimatedSprite leftArm0 = initSprite(Textures.leftArm, 4, 24);
	...
	public static final AnimatedSprite rightThigh0 = initSprite(Textures.rightThigh, 12, 32);
